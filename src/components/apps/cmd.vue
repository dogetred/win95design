...
let userInput: Ref<string> = ref("C:\\Users\\apt>");

let helpOutput: string = "\n commands: [help, cls, whoami, links] \nC:\\Users\\apt>";
let whoamiOutput: string = "\n my name is andryxa and i am software developer. \nC:\\Users\\apt>";
let linksOutput: string = "\n telegram: t.me/infosexblog \n github: github.com/dogetred \nC:\\Users\\apt>";
...
let handleKeydown = (e: KeyboardEvent): void => {
    ...
    if (e.key === 'Enter') {
        ...
        if (command.toLowerCase() === "help") {
            ...
            userInput.value = "C:\\Users\\aptxayc>";
        }
